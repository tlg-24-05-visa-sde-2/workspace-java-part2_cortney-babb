...
public class InMemoryCatalog implements Catalog {
     ...
     */
    @Override
    public MusicItem findById(Long id) { // pretend this comes in as 6
        MusicItem item = null;
    ...
    public Collection<MusicItem> findByKeyword(String keyword) {
        ...
        for (MusicItem key : catalogData) {
            if (key.getTitle().contains(keyword) || key.getArtist().contains(keyword)) {
                items.add(key);
            }
        }
        return items;
     ...
     */
    @Override
    public Collection<MusicItem> findByCategory(MusicCategory category) { // category pop
...
//        return result;
     ...
     */
    public int genreSales(MusicCategory genre) {
        int genreCount = 0;
